...
import {BoardResponse, ReportPostList} from "@/type/boardResponse";
...
export default function ReportBoard() {
    const [posts, setPosts] = useState<ReportPostList[]>([]);
    ...
    const columns: Column<ReportPostList>[] = [
